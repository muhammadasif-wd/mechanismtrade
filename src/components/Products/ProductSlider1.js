...
import img1 from "../../Assets/img/products/p1.png";
import img2 from "../../Assets/img/products/p2.png";
import img3 from "../../Assets/img/products/p3.png";
...
const ProductSlider1 = () => {
  ...
  return (
    <div className="bg-pink-400">
      <div className=" lg:gap-x-5  my-10 ">
        {/* {/  Carousel  /} */}
